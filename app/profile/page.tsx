    ...
    return (
      <Stack
        ...
        sx={{
          ...
          padding: "2px",
          borderRadius: "12px",
          background: "linear-gradient(80deg, #00ffff, #e909e9, #00ffff)",
      ...
      >
        ...
        >
          <Stack direction="row" alignItems="center" spacing={1}>
            <HomeIcon />
            <Typography>Ninh Kiều - Cần Thơ</Typography>
          </Stack>
          ...
          <Stack direction="row" alignItems="center" spacing={1}>
            <AlarmOnIcon />
            <Typography>08:00 AM - 18:00 PM</Typography>
          </Stack>
        </Stack>
      </Stack>
    );
        ...
        <Card>
          ...
          <Box>
            ...
            >
              ...
              <Button>
                <img src="/icons/button_edit.png" alt="button edit" />
              </Button>
            </Stack>
          </Box>
          {/* Detail */}
          <Box sx={{ px: 2, pb: 2 }}>
            ...
            <Box title={"Work connections"} sx={{ width: "fit-content" }}>
              <Typography color="#0A66C2">500+ connections</Typography>
            </Box>
            <Box sx={{ pb: 2 }}>
